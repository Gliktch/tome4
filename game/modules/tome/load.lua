...
-- Body parts
ActorInventory:defineInventory(_nt"MAINHAND", _t"In main hand", true, _t"Most weapons are wielded in the main hand.", nil, {equipdoll_back="ui/equipdoll/mainhand_inv.png", shimmerable=true})
ActorInventory:defineInventory(_nt"OFFHAND", _t"In off hand", true, _t"You can use shields or a second weapon in your off-hand, if you have the talents for it.", nil, {equipdoll_back="ui/equipdoll/offhand_inv.png", shimmerable=true})
ActorInventory:defineInventory(_nt"PSIONIC_FOCUS", _t"Psionic focus", true, _t"Object held in your telekinetic grasp. It can be a weapon or some other item to provide a benefit to your psionic powers.", nil, {equipdoll_back="ui/equipdoll/psionic_inv.png", etheral=true})
ActorInventory:defineInventory(_nt"FINGER", _t"On fingers", true, _t"Rings are worn on fingers.", nil, {equipdoll_back="ui/equipdoll/ring_inv.png"})
ActorInventory:defineInventory(_nt"NECK", _t"Around neck", true, _t"Amulets are worn around the neck.", nil, {equipdoll_back="ui/equipdoll/amulet_inv.png"})
ActorInventory:defineInventory(_nt"LITE", _t"Light source", true, _t"A light source allows you to see in the dark places of the world.", nil, {equipdoll_back="ui/equipdoll/light_inv.png"})
ActorInventory:defineInventory(_nt"BODY", _t"Main armor", true, _t"Armor protects you from physical attacks. The heavier the armor the more it hinders the use of talents and spells.", nil, {equipdoll_back="ui/equipdoll/body_inv.png", shimmerable=true})
ActorInventory:defineInventory(_nt"CLOAK", _t"Cloak", true, _t"A cloak can simply keep you warm or grant you wondrous powers should you find a magical one.", nil, {equipdoll_back="ui/equipdoll/cloak_inv.png", shimmerable=true})
ActorInventory:defineInventory(_nt"HEAD", _t"On head", true, _t"You can wear helmets or crowns on your head.", nil, {equipdoll_back="ui/equipdoll/head_inv.png", shimmerable=true})
ActorInventory:defineInventory(_nt"BELT", _t"Around waist", true, _t"Belts are worn around your waist.", nil, {equipdoll_back="ui/equipdoll/belt_inv.png"})
ActorInventory:defineInventory(_nt"HANDS", _t"On hands", true, _t"Various gloves can be worn on your hands.", nil, {equipdoll_back="ui/equipdoll/hands_inv.png", shimmerable=true})
ActorInventory:defineInventory(_nt"FEET", _t"On feet", true, _t"Sandals or boots can be worn on your feet.", nil, {equipdoll_back="ui/equipdoll/boots_inv.png", shimmerable=true})
ActorInventory:defineInventory(_nt"TOOL", _t"Tool", true, _t"This is your readied tool, always available immediately.", nil, {equipdoll_back="ui/equipdoll/tool_inv.png"})
ActorInventory:defineInventory(_nt"QUIVER", _t"Quiver", true, _t"Your readied ammo.", nil, {equipdoll_back="ui/equipdoll/ammo_inv.png", shimmerable=true})
ActorInventory:defineInventory(_nt"GEM", _t"Socketed Gems", true, _t"Gems worn in/on the body, providing their worn bonuses.", nil, {equipdoll_back="ui/equipdoll/gem_inv.png", stack_limit = 1})
ActorInventory:defineInventory(_nt"QS_MAINHAND", _t"Second weapon set: In main hand", false, _t"Weapon Set 2: Most weapons are wielded in the main hand. Press 'x' to switch weapon sets.", true)
ActorInventory:defineInventory(_nt"QS_OFFHAND", _t"Second weapon set: In off hand", false, _t"Weapon Set 2: You can use shields or a second weapon in your off-hand, if you have the talents for it. Press 'x' to switch weapon sets.", true)
ActorInventory:defineInventory(_nt"QS_PSIONIC_FOCUS", _t"Second weapon set: psionic focus", false, _t"Weapon Set 2: Object held in your telekinetic grasp. It can be a weapon or some other item to provide a benefit to your psionic powers. Press 'x' to switch weapon sets.", true)
ActorInventory:defineInventory(_nt"QS_QUIVER", _t"Second weapon set: Quiver", false, _t"Weapon Set 2: Your readied ammo.", true)
ActorInventory:defineInventory(_nt"SWIFT_HANDS", _t"Swift Hands", false, _t"List of items that can be instantly used by swift hands.", true)

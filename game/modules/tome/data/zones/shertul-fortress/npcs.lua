...
newEntity{ base = "BASE_NPC_HORROR", define_as="WEIRDLING_BEAST",
	...
	desc = _t"A roughly humanoid creature, with tentacle-like appendages in the place of arms and legs. You gasp in horror as you notice it has no head. Putrid warts form quickly on its skin and explode as quickly.",
	killer_message = _t"and slowly consumed",
...
newEntity{ base = "BASE_NPC_HORROR", define_as="BUTLER",
	...
	desc = _t"The shadow created by the fortress, it resembles somewhat the horrors you saw previously, but it is not the same.",
	level_range = {19, nil}, exp_worth = 3,
	rank = 3,
	max_life = 300, life_rating = 16,
...
newEntity{ base = "BASE_NPC_CAT", define_as = "KITTY",
	...
	desc = _t[[An orange kitty with a white star blaze on his chest. Has a strange affinity for licking your face whenever possible.]],

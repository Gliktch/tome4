...
newEntity{ base="BASE_NPC_ORC_RAK_SHOR", define_as = "RAK_SHOR",
	...
	desc = _t[[An old orc, wearing black robes. He commands his undead armies to destroy you.]],
	killer_message = _t"and raised as a malformed servant",
...
newEntity{ base = "BASE_NPC_GHOUL", define_as = "ROTTING_TITAN",
	...
	desc = _t[[This gigantic mass of flesh and stone moves slowly, the ground rumbling with each step it takes. Its body seems to constantly pulsate and reform. Massive stones at the end of each limb form massive blunt weapons.]],
...
newEntity{ base = "BASE_NPC_GHOST", define_as = "GLACIAL_LEGION",
	...
	desc = _t[[A massive, shifting, ethereal form floats in the air around an orb of frozen blood.  The air around it condenses into freezing pools on the floor beneath it.]],
	level_range = {45, nil}, exp_worth = 2,
	rarity = 25,
	size_category=5,
	rank = 3.5,
...
newEntity{ base = "BASE_NPC_BONE_GIANT", define_as = "HEAVY_SENTINEL",
	...
	desc = _t[[A towering creature, made from the bones of countless bodies. An aura of flame billows from within its chest.]],

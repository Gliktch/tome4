...
newEntity{ base = "BASE_NPC_OGRE",
	...
	desc = _t[[This huge mass of deformed flesh was probably once an ogre, but something had gone wrong.]],
	resolvers.nice_tile{tall=1},
...
newEntity{ base = "BASE_NPC_OGRE",
	...
	desc = _t[[This ogre seems to have tried to graft golem parts on its own body. To various interresting results.]],
	resolvers.nice_tile{tall=1},
...
newEntity{ base = "BASE_NPC_OGRE", define_as = "OGRE_SENTRY",
	...
	resolvers.nice_tile{tall=1},
	desc = _t[[This greatsword-wielding ogre looks at you with contempt and hatred.]],
...
newEntity{ base = "BASE_NPC_OGRE", define_as = "HEALER_ASTELRID",
	...
	resolvers.nice_tile{tall=1},
	desc = _t[[An enormous ogre, clad in a tattered set of robes with an officer's badge.  She clutches a healer's staff, wrapped in casting plaster and scalpels for use as a massive spiked club.]],

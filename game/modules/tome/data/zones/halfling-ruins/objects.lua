...
newEntity{ base = "BASE_LORE",
	...
	desc = _t[[A very faded research note, nearly unreadable.]],
	rarity = false,
	encumberance = 0,
}
end
newEntity{ base = "BASE_LORE",
	...
	desc = _t[[A very faded note, nearly unreadable.]],
	rarity = false,
	encumberance = 0,
}
...
newEntity{ base = "BASE_CLOTH_ARMOR",
	...
	desc = _t[[A beautifully soft robe of fine white fur. It looks designed for a halfling noble, with glorious sapphires sewn across the hems. But entrancing as it is, you can't help but feel a little queasy wearing it.]],
	level_range = {16, 30},
	rarity = 20,
	cost = 250,
	material_level = 3,

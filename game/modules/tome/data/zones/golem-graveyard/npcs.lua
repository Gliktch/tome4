...
newEntity{ define_as = "ATAMATHON", base = "BASE_NPC_CONSTRUCT",
	...
	emote_random = resolvers.emote_random{ chance=20,
		_t"DESTROY!",
		_t"LIFE-ENDING SYSTEMS ACTIVATED!",
		_t"GLORY TO THE HALFLINGS!",
		_t"YOUR DEATH IS NECESSARY",
		_t"ACTIVATING PAIN GIVING SUBMODULES!",
		_t"YOUR LIFE WILL END, PLEASE DO NOT RESIST!",
		_t"RESISTANCE IS FUTILE, YOUR WILL BE EXTERMINATED!",
		_t"PLEASE STAY STEADY AS YOU ARE ERASED FROM THE WORLD!",
		_t"EXECUTE PHASE COMMENCING!",
	},

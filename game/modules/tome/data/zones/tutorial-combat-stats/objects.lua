...
newEntity{ base = "BASE_HEAVY_BOOTS", define_as = "PHYSSAVE_BOOTS",
	...
	encumber = 1,
	rarity = 300,
	desc = _t[[Fine boots that increase your Physical Save by 10.]],
	cost = 100,
	wielder = {
...
newEntity{ base = "BASE_AMULET", define_as = "MINDPOWER_AMULET",
	...
	encumber = 1,
	rarity = 300,
	desc = _t[[A beautiful amulet that increases your Mindpower by 3.]],
	cost = 100,
	wielder = {
		combat_mindpower = 3,
	},
...
newEntity{ base = "BASE_HELM", define_as = "ACCURACY_HELM",
	...
	encumber = 1,
	rarity = 300,
	desc = _t[[A finely-wrought helmet that increases your Accuracy by 6.]],
	cost = 100,
	wielder = {
		combat_atk = 6,
	},

...
newEntity{ name = "skeletal rat",
	...
	define_as = "SKELERAT",
	type = "undead",
	desc = _t[[The diminutive skeleton of a giant rat, charged with evil energies. Nobody understands the usefulness of undead rodents until several of them come after you.]],
	color = colors.GOLD,
	level_range = {3, 4},
	exp_worth = 2,
	rank = 3,
...
newEntity{ name = "golden crystal",
	...
	desc = _t"A formation of golden crystal. It emits a golden radiance equalling the sun itself.",
	level_range = {1, 99},
	exp_worth = 2,
	rank = 3,
...
newEntity{ name = "master alchemist",
	...
	desc = _t[[Deadly fighters using explosive gems to attack.]],
...
newEntity{ name = "multihued wyrmic",
	...
	desc = _t[[A powerful wyrmic with mastery over several elements.]],
...
newEntity{ name = "master slinger",
	...
	desc = _t[[Expert slingers on hire by the arena. They are great at their jobs.]],
...
newEntity{ name = "gladiator",
	...
	desc = _t[[Mercenaries hired by the arena for the sole purpose of entertainment. They make a living beating people up.]],
...
newEntity{ name = "Ryal",
	...
	desc = _t"A gargantuan bone giant resembling a wingless wyrm. He is fully sentient and surprisingly fast.",
	rank = 4, unique = true,
	resolvers.equip{
...
newEntity{ name = "Fryjia Loren",
	...
	display = "@",
	color=colors.VIOLET,
	desc = _t[[A young girl with skin pale as snow. She is small, but deadly in battle, unleashing a constant barrage of ice shards.]],
...
newEntity{ name = "Riala Shalarak",
	...
	display = "@",
	color=colors.VIOLET,
	desc = _t[[A strong female magician. Years of experience make her a dangerous combatant.]],
...
newEntity{ name = "Valfren Loren",
	...
	desc = _t[[A massive suit of armor with a massive axe containing a massively cursed person. He is cursed to fight eternally.]],
...
newEntity{ name = "Rej Arkatis",
	...
	desc = _t[[A Cornac fighter of respectable talent. He emerged from nowhere and became the true master of fighting.]],
...
newEntity{ name = "slinger",
	...
	desc = _t[[Ranged fighters coming to the arena looking for wealth and glory, just like you.]],
...
newEntity{ name = "blood mage",
	...
	stats = { str = 7, dex = 11, cun = 1, mag = 11, con = 6 },
	desc = _t[[A man dressed in black robes. You feel weak as you hear his ominous chanting.]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 40,
	equipment = resolvers.equip{
...
newEntity{ name = "hexer",
	...
	desc = _t[[A man dressed in black robes. You feel a thousand curses being put on you.]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 10,
	equipment = resolvers.equip{
...
newEntity{ name = "rogue",
	...
	desc = _t[[Stealthy fighters trying to achieve victory with trickery. Be careful or they will steal your sight!]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 60,
	resolvers.equip{
...
newEntity{ name = "trickster",
	...
	desc = _t[[Stealthy ranged fighters trying to achieve victory with trickery. Be careful or they will shoot your heart!]],
	level_range = {1, nil}, exp_worth = 1,
	rarity = 1,
	max_life = 60,
	resolvers.equip{
...
newEntity{ name = "ice wyrmic",
	...
	resolvers.drops{chance=30, nb=1, {type="scroll"}},
	stats = { str = 10, dex = 10, mag = 10, con = 9, wil = 15},
	desc = _t[[An ice wyrmic aspiring to win the tournament. He comes paired with a fire wyrmic.]],
	level_range = {1, nil}, exp_worth = 1, autolevel = "wyrmic",
	rarity = 1,
	female = true,
	max_life = resolvers.rngavg(90,105),
...
newEntity{ name = "sand wyrmic",
	...
	resolvers.drops{chance=30, nb=1, {type="scroll"}},
	stats = { str = 10, dex = 10, mag = 10, con = 9, wil = 15},
	desc = _t[[A sand wyrmic aspiring to win the tournament. He comes paired with a storm wyrmic.]],
	level_range = {1, nil}, exp_worth = 1, autolevel = "wyrmic",
	rarity = 1,
	max_life = resolvers.rngavg(90,105),
...
newEntity{ name = "storm wyrmic",
	...
	resolvers.drops{chance=30, nb=1, {type="scroll"}},
	stats = { str = 10, dex = 10, mag = 10, con = 9, wil = 15},
	desc = _t[[A storm wyrmic aspiring to win the tournament. He comes paired with a sand wyrmic.]],
	level_range = {1, nil}, exp_worth = 1, autolevel = "wyrmic",
	rarity = 1,
	female = true,
	max_life = resolvers.rngavg(90,105),
...
newEntity{ name = "anorithil",
	...
	desc = _t[[Warriors from afar. They use the power of light and darkness against you!]],
	level_range = {15, nil}, exp_worth = 2,
	rarity = 10,
	max_life = 120,
	resolvers.equip{
...
newEntity{ name = "sun paladin",
	...
	desc = _t[[Warriors from afar. They wield the power of light, and a mean sword.]],
	level_range = {15, nil}, exp_worth = 2,
	rarity = 10,
	max_life = 150,
	resolvers.equip{
...
newEntity{ name = "star crusader",
	...
	desc = _t[[Warriors from afar. They wield the power of light, and a mean sword. Darkness, too.]],
	level_range = {20, nil}, exp_worth = 2,
	rarity = 10,
	max_life = 150,
	stun_immune = 0.9,

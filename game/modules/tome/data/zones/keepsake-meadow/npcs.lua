...
newEntity{ base = "BASE_SHADOW", define_as = "SHADOW_CLAW",
	...
	desc = _t[[A shadow, almost humanoid in shape. Long claws extend in front of it as is swims through the air.]],
...
newEntity{ base = "BASE_SHADOW", define_as = "SHADOW_STALKER",
	...
	desc = _t[[A shadow, almost humanoid in shape. It seems to move carefully and with cunning before swiftly striking.]],
	rarity = 5, cave_rarity = 5, vault_rarity = 5,
...
newEntity{ base = "BASE_SHADOW", define_as = "SHADOW_CASTER",
	...
	desc = _t[[A shadow, almost humanoid in shape. At times its form seems to be a force of will rather than something real.]],
	rarity = 5, cave_rarity = 5, vault_rarity = 5,
...
newEntity{ base = "BASE_BERETHH_COMPANION", define_as = "BERETHH_WARRIOR",
	...
	desc = _t[[This elf is a companion of Berethh. He's dressed in light armor and wields a sword.]],
...
newEntity{ base = "BASE_BERETHH_COMPANION", define_as = "BERETHH_ARCHER",
	...
	desc = _t[[This elf is a companion of Berethh. He's dressed in light armor and wields a bow.]],
...
newEntity{ define_as="KYLESS",
	...
	desc = _t"This is Kyless, your old friend. He seems dirtier than you recall and a good bit more dangerous.",
	killer_message = _t"and fed to his corrupted dogs",
...
newEntity{ define_as="BERETHH",
	...
	desc = _t"This is Berethh, your old friend. He is dressed in well-worn leather and skillfully wields a bow. There is something noble about the way he carries himself but his expression carries no emotion.",
	killer_message = _t"and quickly burned in a pyre",
	level_range = {20, 35}, exp_worth = 2,
	rank = 4,
	autolevel = "archer",

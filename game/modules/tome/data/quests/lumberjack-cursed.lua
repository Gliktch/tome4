	...
	if self:isCompleted() then
		...
		if self.lumberjacks_died < 7 then
			...
			if o then
				...
				require("engine.ui.Dialog"):simplePopup(_t"Thanks", ("You saved %s of us, please take this as a reward. (They give you %s)"):tformat(self.lumberjacks_died == 0 and "all" or "most", o:getName{do_color=true}))
			end
		end

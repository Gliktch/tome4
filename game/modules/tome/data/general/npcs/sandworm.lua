...
newEntity{ base = "BASE_NPC_SANDWORM",
	name = "sandworm",
	desc = _t[[A huge worm coloured as the sand it inhabits. It seems quite unhappy about you being in its lair.]],
	rarity = 1,
}
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	desc = _t[[A huge worm coloured as the sand it inhabits. This particular sandworm seems to have been bred for one purpose only: the eradication of everything that is non-sandworm, such as... you.]],
	rarity = 3,
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	desc = _t[[This unholy creature looks like a wingless dragon in shape, but it is sand-colored, making it all the more dangerous for its prey.]],
	rarity = 5,
	rank = 3,
	size_category = 5,
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	desc = _t"The ground shakes as this huge worm burrows towards you, its gigantic mouth just as capable of devouring flesh as stone.",
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	desc = _t"Space and time seem to bend around this huge worm.",
	level_range = {20, nil}, exp_worth = 1,
	rarity = 5,
	size_category = 4,
...
newEntity{ base = "BASE_NPC_SANDWORM",
	...
	desc = _t"This huge worm burrows through the earth using its powerful corrosive saliva.",
	level_range = {20, nil}, exp_worth = 1,
	rarity = 3,
	size_category = 4,

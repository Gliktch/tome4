...
newTalent{
	...
	getStealthPower = function(self, t) return math.max(0, math.ceil(self:combatScale(self:getCun(10, true) * self:getTalentLevel(t), 15, 1, 64, 50, 0.25))) end, --TL 5, cun 100 = 64

...
newTalent{
	...
	info = function(self, t)
		...
		tformat(self:getTalentRadius(t), t.getDuration(self, t), t.getSightLoss(self,t), Desc.vs(Desc.acc, Desc.ps), slot)
	end,
}
...
#YELLOW#Prepared with: %s#LAST#]]):
	tformat(damDesc(self, DamageType.PHYSICAL, dam), Desc.vs(Desc.acc, Desc.ps), power, slot)
	end,
}
...
#YELLOW#Prepared with: %s#LAST#]]):
	tformat(range, Desc.vs(Desc.acc, Desc.ps), slot)
	end,
}

...
newTalent{
	...
	info = function(self, t)
		return ([[Hits the target with two shield strikes, doing %d%% and %d%% shield damage. If it hits a second time, it stuns the target for %d turns (Accuracy(Strength) vs Physical Save)).]])
...
newTalent{
	...
	info = function(self, t)
		...
		The distance increases with your talent level, and the Daze duration with your Strength.]]):tformat(t.getShieldDamage(self, t)*100, t.getDist(self, t), Desc.vs(Desc.acc, Desc.ps), t.getDuration(self, t))
	end,
}

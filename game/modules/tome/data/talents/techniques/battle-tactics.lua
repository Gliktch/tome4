...
newTalent{
	...
	info = function(self, t)
		...
		If the attack hits, the target will bleed for %d%% weapon damage over 7 turns %s, and all healing will be reduced by %d%%.]]):
		tformat(100 * self:combatTalentWeaponDamage(t, 1, 1.7), 100 * self:combatTalentWeaponDamage(t, 2, 3.2), Desc.vs(Desc.acc, Desc.ps), heal)
	end,
}

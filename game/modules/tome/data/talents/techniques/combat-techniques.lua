...
newTalent{
	...
	info = function(self, t)
		return ([[Rush toward a target enemy with incredible speed and perform a melee attack for 120%% weapon damage that can daze the target for 3 turns if it hits %s.

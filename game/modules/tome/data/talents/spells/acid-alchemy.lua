...
newTalent{
	...
	info = function(self, t)
		...
		tformat(radius, damDesc(self, DamageType.ACID, damage), duration, slow, Desc.vs(Desc.sp, Desc.ps))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		The damage increases with your Spellpower.]]):tformat(damDesc(self, DamageType.ACID, damage), t.getRemoveCount(self, t), Desc.vs(Desc.sp, Desc.ss))
	end,
}

...
newTalent{
	...
	info = function(self, t)
		...
		The damage threshold and darkness damage will scale with your Mindpower.]]):tformat(radius, duration, Desc.vs(Desc.mp, Desc.ms), power, damDesc(self, DamageType.DARKNESS, (damage)), insomnia)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		If a demon manifests the sheer terror will remove all sleep effects from the victim, but not the Inner Demons.]]):tformat(Desc.vs(Desc.mp, Desc.ms), duration, chance)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		tformat(damDesc(self, DamageType.DARKNESS, (damage)), duration, Desc.vs(Desc.mp, Desc.ms), chance, Desc.vs())
	end,
}

...
newTalent{
	...
	info = function(self, t)
		...
		tformat(100 * self:combatTalentWeaponDamage(t, 0.9, 1.5), t.duration(self,t), Desc.vs(Desc.mp, Desc.ps))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		tformat(100 * t.getWeaponDamage(self, t), Desc.vs(Desc.mp, Desc.ps), t.getChance(self, t))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		tformat(100 * t.getWeaponDamage(self, t), damDesc(self, DamageType.PHYSICAL, t.getDamage(self,t)), Desc.vs(Desc.mp, Desc.ps), t.getShatter(self, t))
	end,
}

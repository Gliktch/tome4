...
newTalent{
	...
	info = function(self, t)
		...
		tformat(damDesc(self, DamageType.PHYSICAL, dam), Desc.vs(Desc.mp, Desc.ps))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		tformat(damDesc(self, DamageType.LIGHTNING, dam), self:getTalentRadius(t), Desc.vs(Desc.mp, Desc.ms))
	end,
}

...
newTalent{
	...
	info = function(self, t)
		...
		The chance will increase with your Spellpower.]]):tformat(Desc.vs(), t.getchance(self,t), Desc.vs(Desc.sp, Desc.ss))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		tformat(Desc.vs(Desc.sp, Desc.ss), damDesc(self, DamageType.FIRE, self:combatTalentSpellDamage(t, 4, 90)), t.getCDincrease(self, t)*100)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		The damage will increase with your Spellpower.]]):tformat(Desc.vs(Desc.sp, Desc.ss), t.recoil(self,t))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		If you damage the target, it will be freed from the hex.]]):tformat(t.getDuration(self, t), Desc.vs(Desc.sp, Desc.ss))
	end,
}

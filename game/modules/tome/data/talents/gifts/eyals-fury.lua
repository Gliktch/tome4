...
newTalent{
	...
	info = function(self, t)
		...
		The damage increases with your Mindpower.]]):
		tformat(self:getTalentRadius(t), t.getDuration(self, t), damDesc(self, DamageType.ACID, t.getDamage(self, t)), Desc.vs(Desc.max(Desc.acc, Desc.mp, Desc.sp), Desc.ps), t.getChance(self, t))
	end,
}

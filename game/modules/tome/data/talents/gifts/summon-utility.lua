...
newTalent{ short_name="SPIDER_WEB",
	...
	info = function(self, t)
		return ([[Spread a web and throw it toward your target. If caught, it won't be able to move for %d turns %s.]]):tformat(t.getDuration(self, t), Desc.vs(Desc.pp, Desc.ps))
	end,
}

...
newTalent{
	...
	info = function(self, t)
		...
		The damage will increase with your Willpower.]]):tformat(damDesc(self, DamageType.NATURE, self:combatTalentStatDamage(t, "wil", 30, 460)), Desc.vs(Desc.mp, Desc.ps))
	end,
}
...
newTalent{
	...
	info = function(self, t)
		...
		tformat(t.getDuration(self, t), Desc.vs(Desc.mp, Desc.ps), damDesc(self, DamageType.COLD, self:combatTalentMindDamage(t, 5, 140)))
	end,
}

...
newTalent{
	...
	info = function(self, t)
		...
		This talent will also attack with your shield, if you have one equipped.]]):tformat(Desc.vs(Desc.mp, Desc.ms), duration, -armorChange, -defenseChange, resistPenetration)
	end,
}

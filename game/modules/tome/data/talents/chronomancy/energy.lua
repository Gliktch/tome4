...
newTalent{
	...
	getTalentCount = function(self, t)
		return 1 + math.floor(self:combatTalentLimit(t, 3, 0.1, 2, false, 1.0))
	end,
	...
	info = function(self, t)
		...
		tformat(talentcount, cooldown, Desc.vs(Desc.sp, Desc.ss), cooldown)
	end,
}
...
newTalent{
	...
	info = function(self, t)
		local duration = t.getDuration(self, t)
		return ([[Each turn, for the next %d turns, one of the target's sustained talents will be deactivated %s.]]):tformat(duration, Desc.vs(Desc.sp, Desc.ss))
	end,
}

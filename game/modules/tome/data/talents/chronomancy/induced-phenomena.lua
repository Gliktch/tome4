...
newTalent{
	...
	info = function(self, t)
		...
		The chance and stat reduction will scale with your Spellpower.]]):tformat(aging, Desc.vs(Desc.sp, Desc.ps), Desc.vs(Desc.sp, Desc.ps), Desc.vs(Desc.sp, Desc.ms), regress)
	end,
}
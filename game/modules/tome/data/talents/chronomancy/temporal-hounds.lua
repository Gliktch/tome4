...
newTalent{
	...
	info = function(self, t)
		...
		When you learn this talent, your hounds gain %d%% temporal damage affinity.]]):tformat(damDesc(self, DamageType.TEMPORAL, damage), radius, stat_damage, duration, Desc.vs(Desc.sp, Desc.ss), affinity)
	end,
}

...
newTalent{
	...
	info = function(self, t)
		...
		Your Hymns now fire shadowy beams that will hit up to %d of your foes within radius %d for %0.2f damage, with a 25%% chance of blinding.
		...
		These values scale with your Spellpower.]]):tformat(t.getTargetCount(self, t), self:getTalentRange(t), damDesc(self, DamageType.DARKNESS, t.getDamage(self, t)), t.getNegativeDrain(self, t))
	end,
}

...
#{italic}#It may not bleed, exactly, but you'll make it hurt.#{normal}#]])
		:tformat(100 * damage, t.getDuration(self, t), Desc.vs(Desc.pp, Desc.ps))
	end,
}
...
Every %d points of positive energy increase the radius by 1 (up to 10).]]):tformat(damage, Desc.vs(Desc.max(Desc.pp, Desc.sp, Desc.mp), Desc.ps), mult, t.getRadiusScale(self, t))
	end,
}

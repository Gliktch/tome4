...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*A grim-looking Fighter stands there, clad in mail armour and a large olive cloak. He doesn't appear hostile - his sword is sheathed.*#WHITE#
...
newChat{ id="test",
	text = _t[[#VIOLET#*You are grabbed by two olive-clad warriors and thrown into a crude arena!*

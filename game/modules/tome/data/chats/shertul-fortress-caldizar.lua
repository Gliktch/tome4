...
local speak
if has_staff then
	speak = _t[["You should not be here. How di-"#{normal}# It stops abruptly, and its attention seems to turn to the staff in your hands. #{italic}#"How did you get that?! You fool, you do not know what forces you play with! Get it away from here - BEGONE!"]]
else
	speak = _t[["You should not be here. How did you get here?! BEGONE!"]]
end

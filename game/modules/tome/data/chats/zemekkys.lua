...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*A slot in the door opens and a pair of wild eyes peer out.*#WHITE#
...
-----------------------------------------------------------------
newChat{ id="help",
	text = _t[[Pfaugh! Her goal in life is to waste my time! Maj'Eyal? Why not Narnia or Chicago? Just as easy to send you someplace entirely fictional as Maj'Eyal. Go away.
#LIGHT_GREEN#*Slot slams shut.*#WHITE#]],
	answers = {
		{_t"I got here from Maj'Eyal, didn't I? I have this magic Orb I looted from a dead orc, see, and...", jump="offer"},
	}
}

newChat{ id="offer",
	text = _t[[#LIGHT_GREEN#*Slot opens.*#WHITE#
Orb, you say? That you used to travel here from Maj'Eyal? Surely you don't possess the Orb of Many Ways! It's been lost for ages!]],
	answers = {
		{_t"[Hold up the orb]", jump="offer2"},
	}
}
newChat{ id="offer2",
	text = _t[[#LIGHT_GREEN#*His eyes widen.*#WHITE#
Great Socks of Aeryn! It IS the Orb! Maybe we can get you home after all. Or maybe we can get you embedded in magma a thousand leagues straight down.]],
	answers = {
		{_t"May I come in?", jump="offer3"},
	}
}

newChat{ id="offer3",
	text = _t[[You think I'm letting some filthy @playerdescriptor.race@ in my house with the Orb of Many Ways?
...
It'll require a Resonating Diamond to get it properly prepared. Oh, and I want 100 gold.]],
	answers = {
		{_t"Where can I find all that?", jump="quest"},
	}
}

newChat{ id="quest",
	text = _t[[Try your purse for the 100 gold. As for an Athame and a Resonating Diamond, I assume the orcs have some if they're cooking up portals to use that Orb on. Try the Vor Armory. It so happens that I know a back way in. Never mind why.]],
	answers = {
...
-----------------------------------------------------------------
newChat{ id="athame",
	text = _t[[Of course there was no Resonating Diamond. What makes you think Briagh would let one loose for even a second?]],
	answers = {
		{_t"Briagh?", jump="athame2"},
	}
}
newChat{ id="athame2",
	text = _t[[Briagh the Great Sand Wyrm. Where do you think Resonating Diamonds come from? They're just regular diamonds until they get stuck between Briagh's scales for a few centuries and get infused with his life rhythms. He sleeps on a hoard of precious gems and metals, you see.]],
	answers = {
		{_t"Where might I find Briagh's lair??", jump="athame3"},
	}
}
newChat{ id="athame3",
	text = _t[[Well south of the Sunwall. I'll mark it for you on your map.]],
	answers = {
		{_t"I'll be back with a Resonating Diamond.", action=function(npc, player) player:hasQuest("west-portal"):wyrm_lair(player) end},
	}
}
...
-----------------------------------------------------------------
newChat{ id="complete",
	text = _t[[Yes? You got the Athame, the gem and 100 gold?]],
	answers = {
		{_t"[Give him the gem, the athame and 100 gold]", jump="complete2", cond=check_materials, action=remove_materials},
		{_t"Sorry, it seems I lack some stuff. I will be back."},
	}
}
newChat{ id="complete2",
	text = _t[[#LIGHT_GREEN#*The door opens and a shabby Elf emerges.*#WHITE#
Off we go to prepare the portal!]],
	answers = {
		{_t"[follow him]", action=function(npc, player) player:hasQuest("west-portal"):create_portal(npc, player) end},
	}
}

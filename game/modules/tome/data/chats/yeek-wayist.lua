...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*Before you stands a creature about as tall as a Halfling, covered in small white fur and with a disproportionate head.
...
Why did you save me, stranger? You are not of the Way.]],
	answers = {
		{_t"Well, you seemed to need help.", jump="kindness"},
		{_t"So I could rip your throat myself!", action=function(npc, player) npc:checkAngered(player, false, -200) end},
	}
}

newChat{ id="kindness",
	text = _t[[#LIGHT_GREEN#*The greatsword floats to a less aggressive stance. He seems surprised.*#WHITE#
Then, on behalf of the Way, I thank you.]],
	answers = {
		{_t"What is the Way, and what are you?", jump="what"},
	}
}
...
--		{_t"So you will wander the land alone?", jump="done"},
	}
}

newChat{ id="done",
	text = _t[[I am never alone. I have the Way.]],
	answers = {
		{_t"Farewell, then.", action=function(npc, player) npc:disappear() end},
	}
}

newChat{ id="way",
	text = _t[[I cannot, but I may show you a glimpse.
#LIGHT_GREEN#*He leans toward you. Your mind is suddenly filled with feelings of peace and happiness.*#WHITE#
This is the Way.]],
	answers = {
		{_t"Thank you for this vision. Farewell, my friend.", action=function(npc, player)
			npc:disappear()
...
newChat{ id="yeek-welcome",
	text = _t[[Thank the Way. This... thing... would have killed me.]],
	answers = {
		{_t"The Way sent me to explore this side of the tunnel.", jump="explore"},
	}
}

newChat{ id="explore",
	text = _t[[Yes, me too. We should split up to cover more ground.]],
	answers = {
		{_t"Farewell. We are the Way, always.", action=function()

...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*A dwarf in stained, battered mail armor opens the door.*#WHITE#
Say, you interested in dismembering stuff and getting paid?]],
	answers = {
		{_t"Always.", jump="ominous"},
		{_t"[leave]"},
	}
}

newChat{ id="ominous",
	text = _t[[By the corpses of the gods, I love adventurers. Was about to become one myself when it suddenly hit me. And by "it" I mean "my wife." Har!]],
	answers = {
		{_t"What do you propose?", jump="proposal"},
	}
}
...
newChat{ id="proposal",
	...
	answers = {
		{_t"Sounds like a plan.", jump="help"},
	}
}

newChat{ id="help",
	text = _t[[I make excellent plans. And brews, which the Brotherhood will no doubt make me call 'elixirs' once I'm in. And I'll obey, because they have ways of getting what they want. Now, where were we?]],
	answers = {
		{_t"Aiding you with getting into some Brotherhood. What's in it for me?", jump="competition"},
	}
}

newChat{ id="competition",
	text = _t[[Oh, easy. You get a swig of each brew, of course. They'll put hair on your chest, and possibly your eyelids and fingernails. And, if your aid proves the deciding factor, then I've got a real treat for you: perhaps the last Taint of Purging left in Maj'Eyal.]],
	answers = {
...
newChat{ id="list",
	text = _t[[Right, here's the list. Oh, one more thing. Got me some fellas already out hunting for this stuff, and I'll not play favorites. One of them brings me those ingredients before you do, and you're out of luck. Hurry back.]],
	answers = {
		{_t"I'll be off."},
	}
}
...
Oh, and one other last thing... if you have the time for another errand, though I've got no reward on this one.]],
	answers = {
		{_t"Well, I'll see if I can help.", jump="errand", action=function(npc, player) npc.errand_given = true end},
		{_t"I'm here for profit, not errands - I have the list and will work on it; sort your own sidejobs out.", action=function(npc, player) npc.errand_given = true end},
	}
}
end
...
newChat{ id="welcome",
	text = _t[[#LIGHT_GREEN#*The mailed dwarf opens his door.*#WHITE#
...
newChat{ id="totally-complete",
	text = _t[[#LIGHT_GREEN#*He gleefully claps you on the shoulder.*#WHITE#
...
newChat{ id="complete2",
	text = _t[[Give me an hour or so to make with the alchemy. Don't go anywhere.]],
	answers = {
...
newChat{ id="totally-complete2",
	text = _t[[I'd invite you inside while you wait, but the she-dwarf's in there, and I've grown fond of you.]],
	answers = {
...
newChat{ id="complete3",
	text = _t[[#LIGHT_GREEN#*The dwarf finally returns with a vial.*#WHITE#
...
newChat{ id="totally-complete3",
	text = _t[[#LIGHT_GREEN#*The dwarf finally returns with a vial and a small pouch.*#WHITE#
...
newChat{ id="choice",
	text = _t[[Bless you adventurers. Which will it be?]],
	answers = {
		{("The %s."):tformat(e[1].name), jump="list",
...
if npc.errand_given then
newChat{ id="list",
	text = _t[[Here's a list of the creature bits I need. Good luck with the murdering!]],
	answers = {
		{_t"I'll be off."},
	}
}
...
-- If the elixir got made while you were out:
newChat{ id="poached",
	text = _t[[Er, it seems that while you were out, somebody else managed to bring me the ingredients. I've got no reward for you! Sorry about that, but when time is of the essence, 'first come, first served' is the only sensible policy.]],
	answers = {
		{_t"Hrmph.",

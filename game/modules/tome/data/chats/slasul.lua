...
newChat{ id="quest",
	text = _t[[I see. So the dragon sent you. He told you I am insane, I assume?
...
newChat{ id="givequest",
	text = _t[[Spare me?#LIGHT_GREEN#*He laughs.*#WHITE#
...
newChat{ id="portal_back",
	text = _t[[Use this portal. It will bring you back to his cave; ask him the truth.]],
	answers = {
...
newChat{ id="welcome",
	text = _t[[Thank you for listening to me.]],
	answers = {
...
newChat{ id="cause",
	text = _t[[I secretly hoped you would.
...
In return let me offer you this powerful trident.]],
	answers = {
		...
		{_t"This sounds strange. I need to think about it."},
	}
}

...
function _M:init(data)
	...
	local b_profile = require("engine.ui.Button").new{text=_t"Go to online profile", fct=function() util.browserOpenUrl(data.profile, {is_external=true}) end}
	local b_char = require("engine.ui.Button").new{text=_t"Go to online charsheet", fct=function() util.browserOpenUrl(data.char_link, {is_external=true}) end}

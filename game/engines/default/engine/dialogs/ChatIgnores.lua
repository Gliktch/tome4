...
function _M:init()
	Dialog.init(self, _t"Chat ignore list", 500, 400)
	...
	local c_desc = Textzone.new{width=self.iw - 10, height=1, auto_height=true, text=_t"Click a user to stop ignoring her/his messages."}
	local uis = { 

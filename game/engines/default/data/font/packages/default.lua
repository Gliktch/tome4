...
newPackage{ id = "chinese", name = "Chinese", weight = 100,
	small = {font="/data/font/wqy-microhei.ttc", normal=12, small=10, big=14},
	default = {font="/data/font/wqy-microhei.ttc", normal=16, small=12, big=18},
	bold = {font="/data/font/wqy-microhei.ttc", normal=16, small=12, big=18},
	mono = {font="/data/font/wqy-microhei.ttc", normal=16, small=12, big=18},
	mono_small = {font="/data/font/wqy-microhei.ttc", normal=14, small=10, big=16},
	flyer = {font="/data/font/wqy-microhei.ttc", normal=14, small=12, big=16},
	bignews = {font="/data/font/wqy-microhei.ttc", normal=30},
	resources_normal = {font="/data/font/wqy-microhei.ttc", normal=14},
	resources_small = {font="/data/font/wqy-microhei.ttc", normal=12},
}
